...
<img src="{{ url_for('static', filename='img/plane-design.png') }}"
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/lPdf7RwOlSE?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="centered"></iframe>
...
<img src="{{ url_for('static', filename='img/plane-simulation-results-graph.png') }}"
     alt="results graph"
     class="centered">
