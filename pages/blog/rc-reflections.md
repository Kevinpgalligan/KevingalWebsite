...
Earlier this year, I spent 12 weeks at a programming retreat called the Recurse Center (RC). I [wrote about](/blog/recurse.html) the application process, and I shared a series of [daily updates](/blog/tag/rc.html) from my time there. Now, I'd like to reflect back on the experience as a whole

<!-- , from the projects I worked on, to the people I met and the  -->

 <!-- what I did, what I didn't do, what went well, and what went not-so-amazingly-well. -->
...
- My biggest project was a [BitTorrent client](https://github.com/Kevinpgalligan/cl-bittorrent). This involved writing a parser for the bencoding format; designing a multi-threaded client for communicating with multiple peers at once; writing the networking code for (de)serialising messages and sending them over sockets; and implementing the actual logic for dealing with clients.
...
- Wrote C code that could call assembly, and vice versa. This mostly revolved around the compilation and linking process, rather than having to write any special code. Also learned a bit about the ELF format for executables.
- Made a [shitty guitar tuner](/apps/tuner.html) in less than 1KB. More precisely, it's 903 bytes of HTML and JavaScript. The audio breaks when I play it on my phone, so I need to figure out how to adjust the gain for different devices.
- Visited the Center for Computing History (and wrote a [blog post](/blog/center-computing.html) about it).
- Revived my unfinished [computer emulator](https://github.com/Kevinpgalligan/hidl), which is based on the book *Code: The Hidden Language*. All I did was refactor it a bit and add unit tests. It's still a long way from working!
...
- Pair-programmed with other people on some of the projects above, and also on their projects. Examples of their projects: Paxos protocol, chess engine, ray tracer, WebRTC, CryptoPals, an interpreter in Clojure.
...
- Attended several events that were run by the staff of RC to help us make the most of the experience, e.g. the Building Your Volitional Muscles workshop helps you figure out what to work on.
...
*The loose structure.* You can work on whatever you want, attend as many events as you want, interact with other people as much as you want. The RC faculty and infrastructure enable you to make RC what you want it to be. Helpful stuff includes: Zulip for text chat, a calendar for organising events, Virtual RC/conference rooms for video & audio chats, various faculty-run events, and more! The infrastructure meant I could attend 100% remotely.

*The community!* It's probably the most [diverse](https://www.recurse.com/diversity) and welcoming tech space I've been part of. There are [social rules](https://www.recurse.com/social-rules) in place to prevent various misbehaviours that are common in the programming world ("um, actually, this whole thing you did is pointless because blahhhhhi'mupmyownarse"), and they strive to make each batch of attendees as balanced as possible in terms of race and gender. The results speak for themselves -- I met a lot of cool and inspiring people from a wide range of backgrounds, and everyone was super friendly and supportive! To give one example of the supportiveness, I handed in my thesis during the batch and was pleasantly surprised to be swarmed by congratulations! It sounds cheesy, but it was a privilege to experience RC alongside these wonderful people. I especially liked meeting those who came to programming through a non-traditional route, whether that was English lit. or music or physics.

*The career services.* RC is a recruiting company, and they make money by hooking up companies with good programmers. I like that you can engage with this aspect of RC as much or as little as you want. I had my CV reviewed and got some jobhunting tips, but I really should've made MORE use of their career services. Despite this negligence on my part, however, RC did end up landing me a job! A fellow Recurser sent me a link to a job posting that they thought would suit me. I applied, went through several rounds of interviews, and received an offer a few days ago! Woohoo!
