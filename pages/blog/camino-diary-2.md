...
<img src="{{ url_for('static', filename='img/camino/IMG_20231013_094724.jpg') }}"
     alt="Graffiti on a concrete wall. It says 'coronafraude, mentiravirus, todo es mentira, plandemia'."
     class="centered">
<figcaption>Some funny graffiti. Attempted translation: "Coronafraud, lievirus, everything is a lie, plandemic".</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231013_150804.jpg') }}"
     alt="Lush grass, hills, and fog."
     class="centered">
...
<img src="{{ url_for('static', filename='img/camino/IMG_20231013_153048.jpg') }}"
     alt="Santillana del Mar. Winding cobbled path leads to the town."
     class="centered">
<figcaption>The approach to Santillana del Mar.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231013_153424.jpg') }}"
     alt="In the town. More cobbled streets, stone buildings. And lots of people who look like tourists."
     class="centered">
<figcaption>TOURISTS? On MY Camino?</figcaption>
</figure>
...
<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231013_183540.jpg') }}"
     alt="The front of a building. Two ornate wooden doors with pointy archways. Lots of stone."
     class="centered">
...
<img src="{{ url_for('static', filename='img/camino/IMG_20231014_080858.jpg') }}"
     alt="Wet, cobbled street. Early morning darkness. Moody yellow light from a lamppost."
     class="centered">
<figcaption>Setting off from Santillana del Mar in the rain.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231014_082939_1.jpg') }}"
     alt="A goat looking for pets through a wire fence. Bearded man obliges. The goat has dark fur, light around the eyes and mouth. Big horns. Orangey eyes."
     class="centered">
...
<img src="{{ url_for('static', filename='img/camino/IMG_20231014_134903.jpg') }}"
     alt="A manor house with reddish stone. A church next door seems to be made from similar stone. Grey clouds, and a grassy lawn in the foreground."
     class="centered">
<figcaption>A cool building that I was too lazy to investigate.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231014_143112.jpg') }}"
     alt="Some swampy and sandy land. Lots of water."
     class="centered">
...
<img src="{{ url_for('static', filename='img/camino/IMG_20231015_081518.jpg') }}"
     alt="Dawn scene of San Vicente de la Barquera. Stone buildings, orange lights, and a dark lake in between."
     class="centered">
<figcaption>Farewell to San Vicente.</figcaption>
</figure>
...
<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231015_160753.jpg') }}"
     alt="Lots of trees, greeny-brown foliage, and some mist-covered mountains in the distance."
     class="centered">
<figcaption>Approaching the mountains of Asturias.</figcaption>
</figure>
...
<figure>
<video controls class="centered">
  <source src="{{ url_for('static', filename='img/camino/VID_20231015_143232.mp4') }}" type="video/mp4">
</video> 
<figcaption>Aurora and Wesley under the bridge. Aurora had a surprisingly good set of pipes.</figcaption>
</figure>
...
<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231015_091146.jpg') }}"
     alt="A group of horned cows hanging out. They're brown, blonde and red."
     class="centered">
...
<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231015_174748.jpg') }}"
     class="centered">
<figcaption>Another view from the mountain.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231015_174106.jpg') }}"
     alt="It's the sea! And a beach! From a height."
     class="centered">
<figcaption>One of the lame pictures I took from the vantage point.</figcaption>
</figure>
...
<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231015_180930.jpg') }}"
     class="centered">
<figcaption>A cute sign outside Llanes. "Welcome to Llanes...here you have livestock out and about... cockerels singing early... working dogs (watch your pets)... respect private property and its contents. If this annoys you, maybe you're in the wrong place. If not, then here you'll find a warm welcome and much hospitality."</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231015_200740.jpg') }}"
     class="centered">
<figcaption>Vegan fabana! A stew made of beans, veggies and vegan chorizo.</figcaption>
</figure>
...
<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231016_112824.jpg') }}"
     class="centered">
<figcaption>Some village.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231016_115924.jpg') }}"
     class="centered">
...
<img src="{{ url_for('static', filename='img/camino/IMG_20231016_152124.jpg') }}"
     class="centered">
<figcaption>Cliffs #1.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231016_152938.jpg') }}"
     class="centered">
<figcaption>Cliffs #2.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231016_153926.jpg') }}"
     class="centered">
<figcaption>Cliffs #3.</figcaption>
</figure>

<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231016_162449.jpg') }}"
     class="centered">
...
<figure>
<img src="{{ url_for('static', filename='img/camino/IMG_20231016_093339.jpg') }}"
     class="centered">
<figcaption>The town of Poo. Teehee.</figcaption>
</figure>
